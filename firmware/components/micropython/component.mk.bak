...
MP_EXTRA_INC += -I$(ESPCOMP)/esp_rom/include
MP_EXTRA_INC += -I$(ESPCOMP)/xtensa/include
MP_EXTRA_INC += -I$(ESPCOMP)/xtensa/esp32/include/
MP_EXTRA_INC += -I$(ESPCOMP)/esp_common/include
MP_EXTRA_INC += -I$(ESPCOMP)/esp_wifi/include
MP_EXTRA_INC += -I$(ESPCOMP)/lwip/lwip/src/include/lwip/apps
MP_EXTRA_INC += -I$(ESPCOMP)/fatfs/vfs
MP_EXTRA_INC += -I$(ESPCOMP)/fatfs/diskio
MP_EXTRA_INC += -I$(ESPCOMP)/spiffs/include
MP_EXTRA_INC += -I$(ESPCOMP)/esp_eth/include
